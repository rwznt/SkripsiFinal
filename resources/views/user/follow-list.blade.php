                            ...
                            <ul class="list-group">
                                @foreach ($followers as $follower)
                                    <li class="list-group-item d-flex align-items-center">
                                        <div class="me-3">
                                            <img src="@if($follower->image) {{ asset('storage/profile_image/'. $follower->image) }} @else {{ asset('image/default-picture.jpg') }} @endif" class="rounded-circle" style="width: 50px; height: 50px; object-fit: cover;" alt="{{ $follower->name }}">
                                        </div>
                                        <div>
                        ...
                        @else
                            <ul class="list-group">
                                @foreach ($following as $follow)
                                    <li class="list-group-item d-flex align-items-center">
                                        <div class="me-3">
                                            <img src="@if($follow->image) {{ asset('storage/profile_image/'. $follow->image) }} @else {{ asset('image/default-picture.jpg') }} @endif" class="rounded-circle" style="width: 50px; height: 50px; object-fit: cover;" alt="{{ $follow->name }}">
                                        </div>
                                        <div>
